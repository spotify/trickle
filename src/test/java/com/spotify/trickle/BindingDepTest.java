...
public class BindingDepTest {
  ...
  public void shouldGenerateEqualNodeInfoForSameName() throws Exception {
    ...
    Name<String> name2 = Name.named("ho", String.class);

    BindingDep<String> dep1 = new BindingDep<String>(Name.named("hi", String.class));
    BindingDep<String> dep2 = new BindingDep<String>(Name.named("hi", String.class));
